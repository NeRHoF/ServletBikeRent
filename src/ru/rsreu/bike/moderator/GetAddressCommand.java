...
public class GetAddressCommand  implements ActivityCommand {
	...
	public Activity execute(HttpServletRequest request) {
		...
		return new Activity(ConfigurationManager.getProperty("path.page.pointAddress"), ActivityEnum.FORWARD);
	}
