...
public class GetAdminPageCommand implements ActivityCommand {
	...
	public Activity execute(HttpServletRequest request) {
		...
		return new Activity(ConfigurationManager.getProperty("path.page.adminMain"), ActivityEnum.FORWARD);
	}
