		...
		<main class="hoc container clear">
			...
			Name<br> <input type="text" name="name" value="">
				<br> Login<br> <input type="text"
					...
					type="text" name="password" value=""> <br> <input type="hidden" /> <br>
				<input type="hidden" name="command" value="CHANGE_CLIENT" /> <input
					class="btn btn-primary" type="submit" value="Change" />
			</form>
	</div>
